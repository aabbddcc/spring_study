...
/**
 * Returns whether the url passed is a cross pojo request or not.
 *
 * @param {String} url The url to check
 * @return {Boolean}   Whether it is a cross pojo request or not
...
var isCrossOrigin = function isCrossOrigin(url) {
  ...
  // Check if url is for another pojo/origin
